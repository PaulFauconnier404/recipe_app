    ...
    return  Drawer(
            child: ListView(
              ...
              children:  <Widget>[
                ...
                SizedBox(height: 50,),
                Row_Icons_Text_Drawer(text: 'Accueil', icon: Icons.home, url: "/salt-meal" , voidToUp: LoginData, email: email),
                ...
                Row_Icons_Text_Drawer(text: 'Mon Compte', icon: Icons.person, url: "/update-account"  , voidToUp: UpdateData, email: email),
                Row_Icons_Text_Drawer(text: 'Déconnexion', icon: Icons.logout, url: "/" , voidToUp: LoginData, email: email ),
              ],
            ),
          );
  } 
